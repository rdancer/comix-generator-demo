...
def _generate_images(captions: list[str]) -> list[Image]:
    """
    ...
    image_grid = generate_2x2_image_grid(amended_captions)
...
def generate_2x2_image_grid(captions: list[str]) -> list[Image]:
    """
